...
export function GutterSkelmersdale() {
  useEffect(() => {
    const schema = {
      ...
      '@type': 'LocalBusiness',
      name: 'Gutter Cleaning in Skelmersdale | R.R.M Exterior Cleaning',
      description: 'Professional gutter cleaning in Skelmersdale.',
    ...
    document.title = 'Gutter Cleaning Skelmersdale | Professional Services';
    const meta = document.querySelector('meta[name="description"]');
    if (meta) meta.setAttribute('content', 'Professional gutter cleaning in Skelmersdale. Call: 07845 463877');
    ...
    <Layout>
      ...
      <article className="border-b border-secondary bg-gradient-to-b from-secondary/50 to-background">
        <div className="container-custom section-padding">
          <h1 className="font-display text-4xl font-bold text-foreground mb-4">Professional Gutter Cleaning in Skelmersdale</h1>
