      ...
      <main itemScope itemType="https://schema.org/WebPage" className="min-h-screen">
        ...
        >
          <div className="max-w-5xl mx-auto">
            ...
            <p className="text-gray-600 mb-8 max-w-2xl leading-relaxed">
              ...
              wider {location.county} area. Click any service for {location.name}-specific
              information, pricing, and to request a free no-obligation quote.
            </p>
        ...
        >
          <div className="max-w-3xl mx-auto text-center space-y-6">
            ...
            <p className="text-blue-100 text-lg leading-relaxed">
              Get your free, no-obligation quote from R.R.M External Cleaning Specialist — serving{' '}
              {location.name} and {location.county} since <time dateTime="2016">2016</time>.
            </p>
        ...
        >
          <div className="max-w-5xl mx-auto">
            ...
            >
              Contact Us — Serving {location.name}
            </h2>
            <p className="text-center text-gray-600 mb-10 max-w-xl mx-auto">
              Contact our team for professional exterior cleaning services in {location.name} and
              across {location.county}.
            </p>
