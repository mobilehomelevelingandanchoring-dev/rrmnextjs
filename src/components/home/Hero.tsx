      ...
      <div className="container-custom relative">
        <div className="py-20 md:py-28 lg:py-36 flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-16">
          ...
          <div className="max-w-3xl w-full lg:w-1/2 z-10">
            ...
            >
              Dirty Driveway? Blocked Gutters? We Fix It —{' '}
              <span className="text-accent">Same Week.</span>
            </h1>

            {/* Subtitle */}
            <p className="text-lg md:text-xl text-primary-foreground/85 mb-6 animate-fade-in-delay-1 leading-relaxed max-w-xl">
              R.R.M delivers professional <strong className="text-white">jet washing</strong>, driveway cleaning, roof cleaning &amp; more across Newton-le-Willows, Warrington &amp; the North West. Affordable prices, no hidden fees, free no-obligation quotes.
            </p>
